                            ...
                            <div class="shop-item col-lg-3 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image">
                                        ...
                                        <div class="overlay-box">
                                            <ul class="option-box">
                                                ...
                                                <li><a href="cart?pid=${o.pID}"><span class="fa fa-shopping-bag"></span></a></li>
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <div class="price"><a href="detail?pid=${o.pID}&cid=${o.cateID}"><fmt:formatNumber type="currency" value="${o.price}"/></a></div>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>    
                    ...
                    <div class="shop-pagination">
                        <ul class="clearfix">
                            <li class="prev"><a href="#"><i class="fa fa-angle-left"></i></a></li>
                                ...
                                <li class="page-item ${tag == o ?"active":""}"><a href="home?index=${o}">${o}</a></li>
                                </c:forEach>                           
                    ...
                    <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <c:forEach items="${listP}" var="o">
                                    <div class="shop-item-two col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image">
                                                <a href="detail?pid=${o.pID}"><img src="${o.image}" alt="" /></a>
                                            </div>
                                            <div class="lower-content">
                                                <h3><a href="detail?pid=${o.pID}">${o.pName}</a></h3>
                                                <div class="price"><fmt:formatNumber type="currency" value="${o.price}"/></div>
                                                <a href="cart?pid=${o.pID}" class="theme-btn cart-btn">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
                        ...
                        <div class="content-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column">
                                ...
                                <a href="home" class="theme-btn btn-style-one"><span class="txt">View all products</span></a>
                            </div>
                        </div>
                    </div>
                </div>
